module github.com/cloudbees-compliance/compliance-hub-plugin-jenkins-master
...
require (
	...
	github.com/cloudbees-compliance/chplugin-go v1.18.2
	github.com/cloudbees-compliance/chplugin-service-go v1.16.0
	github.com/cloudbees-compliance/go-common v0.17.0
